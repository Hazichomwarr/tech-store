...
export default function Hero() {
  return (
    ...
    <section className="relative h-[90vh] flex items-center justify-center bg-black text-white overflow-hidden">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-4">HSA Electronics</h1>
        <p className="mt-4 text-xl">Your Neighborhood Tech Plug</p>

        <p className="mt-10 text-gray-300 mb-6 max-w-xl mx-auto">
