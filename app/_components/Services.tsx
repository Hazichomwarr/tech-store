export default function Services() {
  const services = [
    ...
    { title: "🔧 Car Radios", desc: "Fix, unlock, setup" },
    { title: "🔧 DJ Stuff", desc: "Fix, unlock, setup" },
    { title: "🔧 Computers", desc: "Fix, unlock, setup" },
    { title: "🔧 Power Speakers", desc: "Fix, unlock, setup" },
    { title: "🔧 JBL", desc: "Fix, unlock, setup" },
  ];
  return (
